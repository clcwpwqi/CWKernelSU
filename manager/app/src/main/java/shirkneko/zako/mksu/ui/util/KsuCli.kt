...
private fun getKsuDaemonPath(): String {
    return ksuApp.applicationInfo.nativeLibraryDir + File.separator + "zakomk.so"
}
...
fun install() {
    ...
    val magiskboot = File(ksuApp.applicationInfo.nativeLibraryDir, "zakoboot.so").absolutePath
...
fun restoreBoot(
    ...
    val magiskboot = File(ksuApp.applicationInfo.nativeLibraryDir, "zakoboot.so")
