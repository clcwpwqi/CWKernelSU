...
fun install() {
    ...
    val magiskboot = File(ksuApp.applicationInfo.nativeLibraryDir, "zakomkt.so").absolutePath
...
fun restoreBoot(
    ...
    val magiskboot = File(ksuApp.applicationInfo.nativeLibraryDir, "zakomkt.so")
